...
COIN_TGZ='https://github.com/argocoins/argo/releases/download/v1.0.0/argo-ubuntu1604-v1.0.0.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
SENTINEL_REPO='https://github.com/argocoins/sentinel.git'
COIN_NAME='Argo'
COIN_PORT=8989
RPC_PORT=8988
